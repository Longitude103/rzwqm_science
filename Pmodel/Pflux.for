...
!      ENDIF      
     ...
     +l'   
        ...
        IF(4.0*Actp(i)>Stabip(i)) THEN                                         ! Flow From Active P Pool to Stable Inorganic P Pool
          Pflowactstbi(i)= 0.0006*(4.0*Actp(i)-Stabip(i))
       ...
       WRITE(115,'(A,F12.5,A)')'P Flow =',Pflowactstbi(i)*1000,' gm/ha'
        ...
        ELSE                                                                   ! Flow From Stable Inorganic P Pool To Active P Pool  
          Pflowstbiact(i) = 0.1*0.0006*(Stabip(i)-4.0*Actp(i))
 ...
 !        Pflowr1h1(i) = 0.0
   ...
   !      Pflowh1h2=0.0
     ...
     !!+                                        Resdcom(i)*1000,' gm/ha'
        ...
        Frsopmin(i) = Frsopminr(i)*Frsop(i)* 0.6                                         ! Mineralization of Fresh Organic P Pool
